...
\def\cstuida#1{\def\@cstuida{#1}}\def\@cstuida{}
      ...
      \setlength{\@title@width}{8cm}
      {
        \sanhao\song{
          \begin{tabular}{lc}
            ...
            \textbf{学\qquad 号}  &  \underline{\makebox[\@title@width][c]{\textbf{\@cstuida}}}\\
            \textbf{}  &  \underline{\makebox[\@title@width][c]{\textbf{\@cstuidb}}}\\
          \end{tabular}
        }
    }
    \vspace*{40pt}
